...
const CAR_DISTANCE_CLASS = ".ivN21e";
const OUTPUT_INPUT_DIV_CLASS = ".MespJc";
const SPECIAL_FLIGHT_TIME_CLASS = ".uchGue";

const MY_OUTPUT_CONTAINER_NAME = "Greenify-CO2e-container";
// NAME !!! not a CLASS !

const loadAndInjectData = (iconElements)=>{
    console.log("LOADING AND INJECTING DATA...")

    const timeElements = document.querySelectorAll(TIMES_CLASS);
    const transitStepElements = document.querySelectorAll(TRANSIT_STEPS_CLASS);
    const carDistanceElements = document.querySelectorAll(CAR_DISTANCE_CLASS);
    const outputInputDivElements = document.querySelectorAll(OUTPUT_INPUT_DIV_CLASS);
